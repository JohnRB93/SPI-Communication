...
void DMA2_Stream0_IRQHandler(void)
{
	...
	{
		/** Pitich Bending **/
		if(CurrentAnalogReadY > 144) // Pitch is being bent higher than nornal level.
		{
		...
		else if(CurrentAnalogReadY < 141) // Pitch is being bent lower than nornal level.
		{
			int16_t diffY = CurrentAnalogReadY - PreviousAnalogReadY;
			if(diffY >= 2)
			{
		...
		if(CurrentAnalogReadX > 121) // Pitch is being bent higher than nornal level.
		{
		...
		else if(CurrentAnalogReadX < 113) // Pitch is being bent lower than nornal level.
		{
			int16_t diffX = CurrentAnalogReadX - PreviousAnalogReadX;
			if(diffX >= 2)
			{
